...
#else
#define PDP11_CHECK_RESULT(res) do { pdp11_result_t __r = (res);  (void)sizeof(__r); } while(0);
#define PDP11_CHECK_ERROR(res) do { pdp11_result_t __r = (res);  (void)sizeof(__r); } while(0);
#endif
